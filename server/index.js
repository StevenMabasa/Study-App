  ...
  items: {
    ...
    properties: {
      type: {
        ...
        description: 'Question type: multiple_choice for questions 1-10, true_false for questions 11-20.'
      },
      question: {
        type: SchemaType.STRING,
        description: 'Multiple-choice question text, or a single true/false statement for questions 11-20.'
      },
      options: {
        type: SchemaType.ARRAY,
